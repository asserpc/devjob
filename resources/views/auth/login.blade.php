<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" novalidate>
        ...
        {{-- agrego la clases acá eso hace que el boton se mantenga igual en todos lados menos aqui que hice el cambio
            ahora si quiero que el cambio sea en todos entonce modifico el componente  --}}
